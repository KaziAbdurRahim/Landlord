/**
 * Landlord Receipt View/Download Page
 * 
 * Displays and allows downloading of payment receipts for landlords.
 */
...
export default function LandlordReceiptPage() {
      ...
      <DashboardLayout role="landlord">
        <Card>
          <div className="text-center py-8">
            ...
            <Button onClick={() => router.push("/dashboard/landlord/payments")}>
              Back to Payments
            </Button>
          </div>
        </Card>
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center no-print">
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant="outline"
                onClick={() => router.push("/dashboard/landlord/payments")}
              >
                Back to Payments
              </Button>
            </div>
